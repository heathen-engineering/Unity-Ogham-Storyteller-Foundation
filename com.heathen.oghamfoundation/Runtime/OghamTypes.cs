...
namespace Heathen.Ogham
{
    ...
    public enum OghamNodeMode
    {
        ...
        Content,
        /// <summary>Silent routing node: automatically evaluates routes and navigates without raising <see cref="OghamStory.OnEntered"/>.</summary>
        Fork,
    }
    ...
    /// <summary>
    /// A serialisable snapshot of a single <see cref="OghamStory"/> session used for save and restore.
    /// Captures the current entry, narrative state, and conversation history at a point in time.
    /// </summary>
    [Serializable]
    public class OghamSaveState
    {
        /// <summary>A unique identifier for this save state, generated by <see cref="OghamStory.Snapshot"/>.</summary>
        public string Uuid;
        /// <summary>A human-readable label for this save state.</summary>
        public string Name;
        /// <summary>The tag ID of the <see cref="OghamStory"/> this snapshot belongs to.</summary>
